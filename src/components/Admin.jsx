  ...
  return (
    <div className="flex h-screen ">
      <div className="w-[30%] md:w-[300px] lg:w-[220px]    flex flex-col   shadow-gray-600 shadow-lg    ">
        <div className="flex flex-col md:flex-row justify-center md:justify-around align-middle items-center text-center  font-bold  bg-gray-300">
          <div className=" w-[70%] sm:w-1/3 md:w-[25%] lg:w-[30%] flex justify-start md:justify-center text-center align-middle  items-center py-1">
            <img className="flex w-full" src={logo} alt="logo" />
          </div>
          <div className=" sm:flex-col hidden sm:flex justify-center items-center  text-center">
            <h1 className=" flex justify-center  ">ศาลเจ้าปึงเถ่า-กงม่า</h1>
        ...
        <nav>
          ...
          >
            <div>
              <img className="flex sm:mx-5 mb-3 md:mb-0 md:py-2 text-center  items-center justify-center " src={menu1Logo} />
            </div>
